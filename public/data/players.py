...
def readplayers():
    ...
    selected_columns = ["Name", "Team", "OVR", "POT", "POS", "AGE", "Image", "Image1"]

    player_dict = {}

    combined = pd.concat(
        [players[selected_columns], player1[selected_columns]],
        ignore_index=True
    )
    ...
    for _, row in combined.iterrows():
        ...
        player_dict[player_name] = {
            ...
            "POS": row["POS"],
            "AGE": row["AGE"],
            "PlayerImage": row["Image"],   # player face
            "ClubImage": row["Image1"]     # club badge
        }
